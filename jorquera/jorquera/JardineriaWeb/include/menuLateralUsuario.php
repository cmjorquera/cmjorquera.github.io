                ...
                <div id="sidebar-nav" class="list-group border-0 rounded-0 text-sm-start min-vh-100">
                    ...
                    <a href="https://qa.seduc.cl/JardineriaWeb/index.php"
                        class="list-group-item border-end-0 d-inline-block text-truncate" data-bs-parent="#sidebar"><i
                            class="bi bi-bootstrap"></i> <span>Volver a la pag</span>
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <div class="col py-3">
                        <div class="container">
                            ...
                            <div class="" id="div_productos">
                                <button type="button" onclick="listarProductos()" class="btn btn-primary boton">Listar
                                    Productos jorquera
                                </button>
                            </div>
                            ...
                            <div class="row" style="padding: 50px;">
                                <div class="col order-last">
                                    <div class="d-grid gap-5 col-12 mx-auto">
                                        <!-- <button class="btn btn-dark btn-lg button" style="height: 100px;" type="button">
                                Listar los productos
                            </button> -->
                                        <a href="productos.php" class="btn btn-dark btn-lg button"
                                            style="height: 100px;"> Listar los productos</a>
