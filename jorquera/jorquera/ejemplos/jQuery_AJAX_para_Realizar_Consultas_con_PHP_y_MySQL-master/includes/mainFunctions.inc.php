...
define("server", 'localhost');
define("user", 'qaseduc_ucomun');
define("pass", 'jorquera86');
define("mainDataBase", 'qaseduc_seduc_base');
...
// 		$consulta = $linkDB -> query("SELECT *  FROM usuario  ORDER BY id_usuario ASC");
